...
// Header
const String html_init = R"=====(<!DOCTYPE html>
<html>
...
function DumpCondensor() {
    ...
    xhttp.open("GET", "/DumpCondensor", true);
    xhttp.send();
}
